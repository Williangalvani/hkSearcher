...
from models import Motor, Battery
...
def loadBatteries(request):
    ...
    return render_to_response('batteries.html', { 'amm': amm, 'itens': itens2},context_instance=RequestContext(request))
...
def loadMotors(request):
    ...
    return render_to_response('motors.html', { 'amm': amm, 'itens': itens2},context_instance=RequestContext(request))
