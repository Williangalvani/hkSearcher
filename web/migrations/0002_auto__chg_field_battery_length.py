...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Battery.length'
        db.alter_column('web_battery', 'length', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Battery.length'
        db.alter_column('web_battery', 'length', self.gf('django.db.models.fields.FloatField')(default=0))
